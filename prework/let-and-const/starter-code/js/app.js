...
function displayPics(){
  ...
  // console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed 
  // the letiable declaration from `let to `let`.
  // PUT YOUR RESPONSE IN THIS COMMENT

  // Because let is a block scope, so we can't call its declaration variables from out side the while statement 
  console.log(viewed);
